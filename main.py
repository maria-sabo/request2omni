...
def main():
    ...
    Если при запуске программы введены все требуемые аргумента
        Если введенные аргументы прошли проверку функцией check_credentials_correct(), то
            Вызывается основная функция подготовки и отправки полученных заявок prepare_and_sent()
